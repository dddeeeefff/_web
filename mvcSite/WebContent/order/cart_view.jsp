...
// 장바구니내 특정 상품을 삭제하는 함수
	if (confirm("정말 삭제하시겠습니까?")) {
		// cart_proc_del매핑 CartProcDelCtrl
		$.ajax({
			type : "POST", 
...
<tr align="center">
<td width="5%">
	<input type="checkbox" name="chk" value="<%=ocidx %>" checked="checked" />
</td>
<td width="15%">
...
<p align="right" style="width:800px; font-size:1.8em;">총 구매 가격 : <%=total %>원</p>
