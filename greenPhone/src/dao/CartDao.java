...
public class CartDao {
	...
	public ArrayList<SellCart> getCartList(String miid) {
		...
		try {
			...
			String sql = "select a.*, b.pi_id, b.pi_name, b.pi_min, b.pi_dc, b.pi_img1, c.po_name, c.po_idx " + 
						 " from t_sell_cart a, t_product_info b, t_product_option c " +
						 " where a.pi_id = b.pi_id and a.pi_id = c.pi_id and a.po_idx = c.po_idx and pi_isview = 'y' and a.mi_id = '" + miid + "' ";
			stmt = conn.createStatement();
			...
			while (rs.next()) {
				...
				// 占쏙옙占쏙옙 占쏙옙품占쏙옙 占심쇽옙 占쏙옙 占쏙옙占� 占쏙옙占�
				cartList.add(sc);
			}
